...
// Main class for the scholarship finder program
public class Main {
   public static void main(String[] args) {
      
      // Scanner to read user input
       Scanner scanner = new Scanner(System.in);
      // Variables used for menu navigation
       int option = 0;
       char letter = ' ';
       int stateOption = 0;
      ...
      // Main program loop
       while (option != 2) {
           ...
           if (option == 1) {
              ...
              // Loop for minority menu
               while (letter != 'q') {
                  // Display minority options
                  ...
                  // Validate user option
                       ...
                       while(!validOption) {
                          ...
                          // Check if option is valid
                           if (letter == 'a'|| letter == 'b'|| letter == 'c'|| letter == 'd'|| letter == 'e'|| letter == 'q') {
                               ...
                               // If user chooses "other", ask for custom group
                               if (letter == 'e') {
                                   scanner.nextLine();
                       ...
                       // Continue program if user didn't quit
                       if (letter!= 'q') {
                          // Ask for in-state or out-of-state
                       stateOption = 0;
                       ...
                       System.out.println();
                          ...
                          // Scholarship suggestions based on GPA
                       if (gpa <= 2.50) {
